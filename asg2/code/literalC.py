...
def read_file(filename):
	'''
		Read file and save in memory the matrix with the features, and a vector with the labels. We take n features and k classes
	'''
	f1 = open(filename , 'r')
	x = []
	y = []
...
x, y = read_file('../data/svar-set3.dat')
